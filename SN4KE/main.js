...
function openCustomAlert() {
  ...
  function closeCustomAlert() {
    document.getElementById('customAlert').style.animation = 'fadeOut 0.5s ease-in-out'; /* Add fade out animation */
    setTimeout(() => {
      document.getElementById('customAlert').style.display = 'none';
      document.getElementById('customAlert').style.animation = ''; /* Reset animation */
    }, 500);
  }